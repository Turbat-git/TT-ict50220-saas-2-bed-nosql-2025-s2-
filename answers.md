...
> | Budget             | budget          | long or int       | USD $           |
> | Box Office Takings | box_office      | long or int       | USD $           |
...
```js
	db.films.aggregate([
    {
        $match: {
            ...
            box_office: { $exists: true, $ne: null }
        }
    },
    {
        $project: {
...
![img_2.png](assets/images/step-10-003.png)
